...
ARG APP_PATH=/icalia-actions/aws-delete-elb-rule
...
ARG APP_PATH=/icalia-actions/aws-delete-elb-rule
COPY --from=builder --chown=node:node ${APP_PATH} /icalia-actions/aws-delete-elb-rule
WORKDIR /icalia-actions/aws-delete-elb-rule
